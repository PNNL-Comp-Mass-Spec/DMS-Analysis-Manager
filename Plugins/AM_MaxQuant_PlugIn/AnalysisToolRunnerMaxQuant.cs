...
namespace AnalysisManagerMaxQuantPlugIn
{
    ...
    public class AnalysisToolRunnerMaxQuant : AnalysisToolRunnerBase
    {
        ...
        /// <param name="combinedDirectory">Target directory</param>
        ...
        /// <param name="doc">XML document</param>
        /// <param name="parentNodeName">Parent node name</param>
        /// <param name="childNodes">Child nodes to add</param>
...
#pragma warning restore CS0162 // Unreachable code detected
        ...
        /// </summary>
        /// <param name="localOrgDbDirectory">Local FASTA file storage directory</param>
        ...
        /// <param name="fileUpdated">Output: true if the parameter file was updated</param>
        /// <returns>True if success, false if an error</returns>
        ...
        /// </summary>
        /// <param name="workingDirectory">Working directory</param>
        /// <param name="metadataFile">Andromeda peak list metadata file</param>
        /// <param name="andromedaParameterFiles">List of Andromeda parameter files</param>
        /// <returns>True if success, false if an error</returns>
