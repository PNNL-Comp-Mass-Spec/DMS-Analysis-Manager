...
Public Class clsRenumberMzXMLScans
	...
	Public Function Process(ByVal targetFilePath As String) As Boolean
		...
		Try
			...
			Using reader = New XmlTextReader(New FileStream(mSourceMzXmlFile, FileMode.Open, FileAccess.Read, FileShare.Read))
				...
				Using writer = New XmlTextWriter(New FileStream(targetFilePath, FileMode.Create, FileAccess.Write, FileShare.Read), System.Text.Encoding.GetEncoding("ISO-8859-1"))
	...
	Protected Function IndexMzXmlFile(ByVal filePath As String) As Boolean
