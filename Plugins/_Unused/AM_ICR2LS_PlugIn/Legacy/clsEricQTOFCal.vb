...
Public Class clsEricQTOFCal

#Region "DLL and API calls"
    Private Declare Function EricTOFCalFnc Lib ".\EricTOF.dll" (ByVal file As String, _
    ByVal out As String, ByRef hndl As Integer) As Short
...
#End Region
    ...
    Private Function ReallyPerformCal(ByVal InputFile As String, ByVal OutputFile As String) As Boolean
        ...
        Try
            ...
            EricTOFCalFnc(InputFile, OutputFile, Hndl)
