...
#Region "Methods"
    ...
    Protected Sub DeleteTransferFolderIfEmpty()
        ...
        Try
            ...
            If diTransferFolder.Exists AndAlso diTransferFolder.GetFileSystemInfos("*", SearchOption.AllDirectories).Count = 0 Then
                ...
                Catch ex As Exception
                    ...
                    Dim msg = "clsResultXferToolRunner.RunTool(); Exception deleting dataset folder " &
        ...
        Catch ex As Exception
            ' Log this exception, but don't treat it is a job failure
            Dim msg = "clsResultXferToolRunner.RunTool(); Exception looking for dataset folder " &
                m_jobParams.GetParam("DatasetFolderName") & " in xfer folder (another results manager may have deleted it): " & ex.Message
            clsLogTools.WriteLog(clsLogTools.LoggerTypes.LogFile, clsLogTools.LogLevels.WARN, msg)
        End Try
    ...
    Private Function GetMachineNameFromPath(uncFolderPath As String) As String
    ...
    Protected Function LookupLocalPath(
       ...
       uncFolderPath As String,
       folderFunction As String,
       connectionString As String) As String
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Protected Function MoveFilesLocally(sourceFolderpath As String, targetFolderPath As String, overwriteExisting As Boolean) As Boolean
    ...
    Protected Overridable Function PerformResultsXfer() As IJobParams.CloseOutType
        ...
        Const blnOverwriteExisting = True
