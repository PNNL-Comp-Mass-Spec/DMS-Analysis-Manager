...
#Region "Properties"
    ...
    Public Property DeconFileType() As DeconToolsV2.Readers.FileType
        ...
        End Get
        Set(ByVal Value As DeconToolsV2.Readers.FileType)
...
#Region "Methods"
   ...
   ByVal OutFile As String, ByVal ParameterFile As String)
    ...
    Public Overloads Sub DeConvolute(ByVal DataFile As String, ByVal FileType As DeconToolsV2.Readers.FileType, _
      ByVal OutFile As String, ByVal ParameterFile As String)
