...
#Region "Module variables"
    Dim WithEvents m_FlagFileWatcher As System.IO.FileSystemWatcher
...
#Region "Methods"
    Sub Main()
        ...
        Dim Channel As System.Runtime.Remoting.Channels.Tcp.TcpServerChannel = New System.Runtime.Remoting.Channels.Tcp.TcpServerChannel(m_TcpPort)
        System.Runtime.Remoting.Channels.ChannelServices.RegisterChannel(Channel, False)

        'Register the client activated object
        System.Runtime.Remoting.RemotingConfiguration.RegisterActivatedServiceType(GetType(Decon2LSRemoter.clsDecon2LSRemoter))
    ...
    Private Sub InitFileWatcher()
        ...
        m_FlagFileWatcher = New System.IO.FileSystemWatcher(m_FlagFilePath)
