...
Public Class clsAnalysisResourcesDtaRefinery
    ...
    Private Function RetrieveDeconMSnLogFiles() As Boolean
    ...
    Private Sub DeleteFileIfNoData(fileName As String, fileDescription As String)
    ...
    Private Function UpdateParameterFile(<Out()> ByRef strErrorMessage As String) As Boolean
    ...
    Private Function ValidateDeconMSnLogFile(strFilePath As String) As Boolean
