...
#End Region
	...
	Public Overrides Function RunTool() As IJobParams.CloseOutType
		...
		'Make sys files, etc if required
		If CBool(m_mgrParams.GetParam("programcontrol", "performextraction")) Then
			result = ExtractDataFromResults()
			If result <> IJobParams.CloseOutType.CLOSEOUT_SUCCESS Then Return result
		End If
	...
	Public Overridable Function ExtractDataFromResults() As IJobParams.CloseOutType
	End Function
