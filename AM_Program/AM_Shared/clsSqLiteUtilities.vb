...
Public Class clsSqLiteUtilities
	...
	Private Function GetDBObjects(ByVal cnDatabase As SQLiteConnection, ByVal objectType As String) As Dictionary(Of String, String)
		Dim tableName As String = String.Empty
		Dim dctIndexToTableMap As Dictionary(Of String, String) = Nothing
		Return GetDBObjects(cnDatabase, objectType, dctIndexToTableMap, tableName)
	End Function

	Private Function GetDBObjects(ByVal cnDatabase As SQLiteConnection, ByVal objectType As String, ByRef dctIndexToTableMap As Dictionary(Of String, String)) As Dictionary(Of String, String)
		Dim tableName As String = String.Empty
		Return GetDBObjects(cnDatabase, objectType, dctIndexToTableMap, tableName)
	End Function
	...
	Private Function GetDBObjects(ByVal cnDatabase As SQLiteConnection, ByVal objectType As String, ByRef dctIndexToTableMap As Dictionary(Of String, String), ByVal tableNameFilter As String) As Dictionary(Of String, String)
