...
#Region "Methods"
    ...
    Public Shared Function ExecuteSP(ByRef SpCmd As SqlCommand, ByVal ConnStr As String, ByVal MaxRetryCount As Integer, ByRef sErrorMessage As String) As Integer
    ...
    ''' <returns>Result code returned by SP; -1 if unable to execute SP</returns>
    ''' <remarks>No logging is performed by this procedure</remarks>
    Public Shared Function ExecuteSP(ByRef SpCmd As SqlCommand, ByVal ConnStr As String, ByVal MaxRetryCount As Integer, ByVal TimeoutSeconds As Integer, ByRef sErrorMessage As String) As Integer
