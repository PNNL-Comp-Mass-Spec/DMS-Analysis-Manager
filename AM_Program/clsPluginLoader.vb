...
#Region "Module variables"
	Private ReadOnly m_msgList As New List(Of String)
	Private ReadOnly m_MgrFolderPath As String
	Private m_pluginConfigFile As String = "plugin_info.xml"
	Private ReadOnly m_SummaryFile As clsSummaryFile
#End Region
...
#If PLUGIN_DEBUG_MODE_ENABLED Then
	...
	Private Function DebugModeGetAnalysisResources(ByVal className As String) As IAnalysisResources
		...
		Select Case className.ToLower()
			...
			'	myModule = DirectCast(New MSMSSpectrumFilterAM.clsAnalysisResourcesMsMsSpectrumFilter, IAnalysisResources)
