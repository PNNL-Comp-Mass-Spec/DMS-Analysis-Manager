...
#End Region
    ...
    Public Sub TestRunSP()
        ...
        Dim cmd = New SqlClient.SqlCommand() With {
            .CommandType = CommandType.StoredProcedure,
            .CommandText = "GetJobStepParamsAsTable"
        }
        cmd.Parameters.Add(New SqlClient.SqlParameter("@Return", SqlDbType.Int)).Direction = ParameterDirection.ReturnValue
        cmd.Parameters.Add(New SqlClient.SqlParameter("@jobNumber", SqlDbType.Int)).Value = 1026591
        cmd.Parameters.Add(New SqlClient.SqlParameter("@stepNumber", SqlDbType.Int)).Value = 3
        cmd.Parameters.Add(New SqlClient.SqlParameter("@message", SqlDbType.VarChar, 512)).Direction = ParameterDirection.Output
